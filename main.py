...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.gltzz = QtWidgets.QAction(MainWindow)
        self.gltzz.setObjectName("gltzz")
        ...
        self.menu_4.addAction(self.gltzz)
        ...
        self.menu_4.triggered[QtWidgets.QAction].connect(self.openQuery)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menu_2.setTitle(_translate("MainWindow", "修改信息"))
        self.menu_3.setTitle(_translate("MainWindow", "退出"))
        self.menu_4.setTitle(_translate("MainWindow", "系统维护"))
        ...
        self.djxry.setText(_translate("MainWindow", "登记新团员"))
        self.scty.setText(_translate("MainWindow", "删除团员"))
        self.action_7.setText(_translate("MainWindow", "修改团员信息"))
        self.tcdl.setText(_translate("MainWindow", "退出登录"))
        self.tcxt.setText(_translate("MainWindow", "退出系统"))
        self.gltzz.setText(_translate("MainWindow", "管理团组织"))
        self.glyh.setText(_translate("MainWindow", "管理用户"))
    # def show(self):
    #     self.m=print("1234")
    def openSet(self,m):
        if m.text()=="团组织查询":
    ...
    def openBase(self,m):
        if m.text()=="登记新团员":
            ...
            self.m = delete.Ui_delete_2()
            self.m.show()
        elif m.text() == "修改团员信息":
            self.m = change.Ui_change()
            self.m.show()
